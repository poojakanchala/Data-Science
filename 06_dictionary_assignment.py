...
print("\nQuestion 15: Create a dictionary with tuple values: {'coordinates': (10, 20), 'rgb': (255, 0, 0)}")
# Your code here
dict1 = {'coordinates': (10, 20), 'rgb': (255, 0, 0)}
print(dict1)
...
print("\nQuestion 17: Create a dictionary with set values: {'vowels': {'a', 'e', 'i'}, 'consonants': {'b', 'c', 'd'}}")
# Your code here
dict1 = {'vowels': {'a', 'e', 'i'}, 'consonants': {'b', 'c', 'd'}}
print(dict1)
...
print("\nQuestion 25: Create a dictionary with lambda functions: {'double': lambda x: x*2, 'square': lambda x: x**2}")
# Your code here
operators={'double': lambda x: x*2, 'square': lambda x: x**2}
print(operators)
# Question 26: Apply each lambda function to 5
print("\nQuestion 26: Apply each lambda function to 5")
# Your code here
operators={'double': lambda x: x*2, 'square': lambda x: x**2}
print(operators['double'](5))
print(operators['square'](5))
# Question 27: Create a dictionary with class values: {'list': list, 'dict': dict, 'set': set}
print("\nQuestion 27: Create a dictionary with class values: {'list': list, 'dict': dict, 'set': set}")
# Your code here
types = {'list': list, 'dict': dict, 'set': set}
print(types)
...
print("\nQuestion 35: Create a 4-level nested dictionary")
# Your code here
nested_dict = {'level1': {'level2': {'level3': {'level4': 'Deep value'}}}}
print(nested_dict)
...
print("\nQuestion 38: Convert each range to list")
# Your code here
squares = {x: range(x) for x in range(1,6)}
converted_dict = {key: list(value) for key, value in squares.items()} 
print(converted_dict)
# Question 39: Create a dictionary with generator values
print("\nQuestion 39: Create a dictionary with generator values")
# Your code here
gen_dict = {'even':(x for x in range(0,10,2)), 'odd': (x for x in range(1,10,2))}
print(list(gen_dict['even']))
print(list(gen_dict['odd']))
...
print("\nQuestion 41: Create a dictionary with iterator values")
# Your code here
iter_dict ={'numbers': iter([1,2,3,4]), 'letters': iter('abcd'), 'range': iter(range(3))}
print(next(iter_dict['numbers']))
print(next(iter_dict['letters']))
print(next(iter_dict['range']))
# Question 42: Extract all elements from each iterator
print("\nQuestion 42: Extract all elements from each iterator")
# Your code here
iter_dict ={'numbers': iter([1,2,3,4]), 'letters': iter('abcd'), 'range': iter(range(3))}
extracted = {key: list(value) for key,value in iter_dict.items()}
print(extracted)
...
# Your code here
import  math
data = {'matrix': [[1, 2], [3, 4]], 'vector': [5, 6, 7]}
sums = {}
sums['matrix'] = sum([sum(row) for row in data['matrix']])
sums['vector'] = sum(data['vector'])
print(sums)
